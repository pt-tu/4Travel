      ...
      <div className="CenterContainer">
        <div className="LocateDateBar">
          <div className="fitterDiv" >
            <div className="fitter" style={{ backgroundColor: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src={location} alt="location" style={{ height: 30, width: 25 ,marginLeft: 10}} />
              <Select
                size="large"
                className="Selector"
                defaultValue="DaNang"
              ...
              <img src={location} alt="location" style={{ height: 30, width: 25 ,marginLeft: 20}} />
              <Select
                size="large"
                className="Selector"
                defaultValue="HaNoi"
          ...
          <Button type="primary" style={{ boxShadow: 'none', height: '50px', borderRadius: '4px', marginTop: '3px', marginRight: '3px', marginLeft: '3px' }}>
            <b>Tìm kiếm</b>
          </Button>

        </div>
        <Search placeholder="Nhập tên hoặc mã tour bạn muốn" className="SearchBar" allowClear enterButton size="large" />
        <div style={{ width: '80%', display: 'flex', justifyContent: "space-between" }}>
          <Button icon={<FilterFilled />} className="ButtonUp"> Lọc</Button>
          <Button icon={<ReloadOutlined />} className="ButtonUp"></Button>
